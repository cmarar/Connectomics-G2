...
50 percent for salary\\*

\subsection{Algorithm modification}
3 Software Engineers @ $300000$ each\\*
$1.8$ million\\*
...
DBS surgery - $100000$ per subject - $10000000$\\*
Electrodes - $6000$\\*
Professor salary - $300000$ per year - $600000$\\*
Clinical physician Salary - $600000$ per year - $600000$\\*
Student Salaries - $100000$ per year, 5 - 1M\\*
MRI technician - $80000$/year - $160000$\\*
Human Subject Salaries - $30000$ per - 30M \\*
Facilities - add 50 percent\\*

\subsection{Additional Costs and Scalability}
This study is currently estimated to cost around $100$ million. Doing 10 times as many subjects would approximately increase the price by 10-fold ($1$ billion). Additionally, the option of developing higher-resolution MRIs and getting such tools approved for clinical trials could range in the billions of dollars as well. Further pursuits might include transitioning into meso-scale imaging instead of the macro-scale provided by MRIs. This would include the development of new technologies which has the possibility of overrunning the current $10$ billion budget. 

We provide a small-scale clinical trial estimated to cost around $100$ million for the sake of feasibility. However, its scalability can run its price into the billions.
...
Mayo Clinic, 2020.
\\\texttt{https://www.mayoclinic.org/tests-procedures/deep-brain-stimulat
ion/about/pac-20384562}
